...
module.exports.calcFirst = function (cur){
    return +cur.meters.cold * cur.cur_plan.cold_plan +
        +cur.meters.hot * cur.cur_plan.hot_plan +
        (+cur.meters.cold + +cur.meters.hot) * cur.cur_plan.cold_plan +
        +cur.meters.day * cur.cur_plan.day_plan +
        +cur.meters.night * cur.cur_plan.night_plan;
}
